...
export default function GlassCard({
    ...
    const variants = {
        default: "",
        "hover-shine": "hover:shadow-[0_0_40px_rgba(37,99,235,0.2)] hover:border-securock-blue/50 group",
        featured: "border-securock-blue/30 bg-securock-blue/[0.08] shadow-[0_0_25px_rgba(37,99,235,0.2)]",
    };

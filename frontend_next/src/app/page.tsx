            ...
            <ScrollReveal variant="fadeUp">
              <div className="rounded-2xl border border-securock-blue/30 bg-gradient-to-r from-securock-blue/15 to-securock-green/10 p-8 md:p-12">
                ...
                <div className="mt-6 flex flex-wrap gap-4">
                  <Button className="bg-securock-blue text-securock-navy hover:bg-securock-blue/90" onClick={() => router.push("/signup")}>
                    Book Assessment
                  </Button>
                  <Button variant="outline" className="border-white/30 bg-transparent text-white hover:bg-white/10" onClick={() => router.push("/services/threat-detection")}>
                    Explore Services
                  </Button>
                </div>
              </div>
